...
export const INITIAL_JOBS: Job[] = [
  ...
  },
  {
    ...
    salary: 'AED 3,500 - 4,000 / month (Tax-Free)',
    employmentType: 'Full-Time',
  ...
  },
  {
    ...
    country: 'Dubai (UAE)',
    category: 'Healthcare & Nursing',
    salary: 'AED 4,000 - 6,000 / month (Tax-Free)',
    employmentType: 'Full-Time',
