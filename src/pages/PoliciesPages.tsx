  ...
  const contentMap = {
    ...
    refund: {
      ...
      body: [
        ...
        '4. Disagreements & Escalations: Candidates can request concern resolution directly by emailing parvisaandcareer94@gmail.com or calling +91 8019021039.'
      ]
    },
    terms: {
      ...
      body: [
        'By accessing or utilizing the services of PAR CAREERS AND VISA CONSULTANCY SERVICES (+91 8019021039), you agree to comply with the following terms:',
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12 space-y-8 animate-fadeIn">
      ...
      <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6 text-slate-700 text-sm leading-relaxed">
        ...
        <div className="pt-6 border-t border-slate-100 text-xs text-slate-500">
          For questions regarding policy terms, contact our senior team at <a href="mailto:parvisaandcareer94@gmail.com" className="text-blue-700 font-bold underline">parvisaandcareer94@gmail.com</a> or Call/WhatsApp <a href="tel:+918019021039" className="text-blue-700 font-bold underline">+91 8019021039</a>.
        </div>
      </div>
    </div>
  );
